    ...
    return (
        <div className="h-screen gap-5 px-[2em] flex items-center justify-center  text-white ">
            ...
            <div className="flex justify-center items-start w-[600px]">
                <div className="w-full flex flex-col justify-center items-center px-10 py-10 bg-gradient-to-br from-[#ffffff] to-[#ffffff] text-left">
                    <img
                        src="/img/Thank you Asset 1.png"
                        alt="Estbanh Logo"
                        className="w-[40%] mb-6"
                    />
                    ...
                    <div className="mt-8">
                        <p className="text-gray-600 text-sm text-center">
                            Your account will be created after we verify all the
                            provided information <br />
                            Once approved by our admin team, you'll receive a
