      ...
      {paths.map((crumb, index) => {
        ...
        return (
          <React.Fragment key={index}>
            ...
            {!isLast && 
              <span className='text-gray-800 font-main text-sm'>
              <svg fill="#000000" width="10px" height="10px" viewBox="0 0 24 24" id="right-2" data-name="Flat Line" xmlns="http://www.w3.org/2000/svg" className="icon flat-line"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><polyline id="primary" points="7.5 3 16.5 12 7.5 21" style={{fill: "none", stroke: "#000000", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2}}></polyline></g></svg>
