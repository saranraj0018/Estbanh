                    ...
                    <div className="transition-all ease-out duration-500 mb-5">
                        ...
                        {approval && (
                            <div className="px-[2.5em] min-h-[20vh] w-full  my-10 border-b-2 border-gray-300 pb-5">
                                <Heading>
                                    Admin the user into the website
                                </Heading>
                                <Text>
                                ...
                                <form className="w-full mt-4" onSubmit={submit}>
                                    <div className="w-full">
                                        ...
                                        <TextInput type="password" onChange={(e) => setData("password", e.target.value)} value={data.password} className="w-full mb-1" />
                                    ...
                                    <div className="w-full mt-5">
                                        ...
                                        <TextInput type="password" onChange={(e) => setData("password_confirmation", e.target.value)} value={data.password_confirmation} className="w-full" />
