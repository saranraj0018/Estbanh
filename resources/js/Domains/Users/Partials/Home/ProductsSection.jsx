        ...
        <section className="px-[10em] my-10 space-y-5">
            ...
            <div className="grid grid-cols-12 gap-3">
                <div className="col-span-12 md:col-span-6">
                    <div className="flex bg-[url('../../resources/js/Assets/home/ProductBG1.png')] bg-cover bg-center bg-no-repeat rounded-2xl p-8 h-full">
                ...
                <div className="col-span-12 md:col-span-6">
                    <div className="flex bg-[url('../../resources/js/Assets/home/ProductBG.png')] bg-cover bg-center bg-no-repeat rounded-2xl p-8 h-full">
                        <div className="space-y-4 my-auto p-3">
            ...
            <div className="grid grid-cols-12 gap-3">
                <div className="col-span-12 md:col-span-4">
                    <div className="flex bg-[url('../../resources/js/Assets/home/pbg1.png')] bg-cover bg-center bg-no-repeat rounded-2xl p-4 h-full">
                        <div className="space-y-4 my-auto p-3">
                ...
                <div className="col-span-12 md:col-span-4">
                    <div className="flex bg-[url('../../resources/js/Assets/home/pbg2.png')] bg-cover bg-center bg-no-repeat rounded-2xl p-4 h-full">
                        <div className="space-y-4 my-auto p-3">
                            <p className="text-black font-main ps-2 border-s-2 border-black text-[13px]">
                                Power Your Projects!
                            </p>
                ...
                <div className="col-span-12 md:col-span-4">
                    <div className="flex bg-[url('../../resources/js/Assets/home/pbg3.png')] bg-cover bg-center bg-no-repeat rounded-2xl p-4 h-full">
                        <div className="space-y-4 my-auto p-3">
                            <p className="text-black font-main ps-2 border-s-2 border-black text-[13px]">
                                Parts That Perform!
                            </p>
