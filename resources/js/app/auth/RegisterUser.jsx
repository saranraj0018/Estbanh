...
import RegisterLayout from "@/shared/layouts/GuestLayout";
import { Head, router, usePage } from "@inertiajs/react";
import { useRegisterContext } from "@/lib/context/RegisterContext.jsx";
            ...
            <div className=" h-full overflow-scroll relative">
                ...
                <form onSubmit={submit} className="">
                    ...
                    <div className="flex mt-4 w-full items-center gap-3">
                        <div className="w-full">
                            ...
                            <TextInput
                                ...
                                onChange={(e) =>
                                    setData("cnr_number", e.target.value)
                                }
                                className="w-full border rounded px-3 py-2 text-sm"
                            />
                    ...
                    <div className="mt-[3em] ">
                        <AppButton
                            className={`w-full mt-6 font-semibold py-2 rounded transition flex items-center justify-center gap-2 ${
                                loading
