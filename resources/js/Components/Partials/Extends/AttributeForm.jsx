    ...
    return (
        <div>
            {attributes.map((attr, index) => (
                <div key={index} className="p-4 pt-10 border-t-2 border-black mt-4">
                        ...
                        <div className="flex ">
                            ...
                            >
                                {attr.minimized ? (
                                    ...
                                    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 15L12 9L18 15" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>
                                )}
                            </button>
                            <button
                                type="button"
                        ...
                        <div className="bg-white border-1 border-gray-300 rounded-lg mt-10">
                            <div className="p-3">
                                <div className="flex justify-between items-center">
                                    ...
                                    <button type="button" className="bg-transparent border-0 outline-0 ring-0" onClick={() => handleAddVariant(index)}>
                                <svg
                                    width="20px"
                                    height="20px"
                                    viewBox="0 0 24 24"
                                ...
                                <div className="border-t-2 mt-4 border-black pb-3">
                                    {attr.variants.map(
                                        (variant, variantIndex) => (
                                            <div
                                                key={variantIndex}
                                                className="mt-10 border-b pb-10 border-black"
                                            >
