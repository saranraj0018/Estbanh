            ...
            <ul className="mt-2 pt-2 h-[90%] px-2">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-[12px] font-[450] mt-[0.09em]">
                            Dashboard
                        </span>
                    </Link>
                </li>
                ...
                <li className="w-full mt-3">
                    <span className=" w-full px-2 py-2 rounded-lg flex gap-4 items-center text-gray-500">
