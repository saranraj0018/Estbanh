import { useURIPathSegment } from "@/lib/hooks/useURIPathSegment";
    ...
    return (
        <div className="mt-2">
            ...
            <div
                ...
                className={`w-full border-2 border-dashed rounded-lg cursor-pointer p-6 text-center transition-all  ${
                    previewSrc
                        ? "border-gray-300 "
